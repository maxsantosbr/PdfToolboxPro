...
import com.pdftoolboxpro.core.ImageToPdf;
...
public class ImagePanel extends JPanel {
    ...
    public ImagePanel() {
        ...
        c.gridx=0; c.weightx=1; cols.add(createColumn("/com/pdftoolboxpro/resources/imagemToPdf.png", "image.step1.title", "image.step1.desc"), c);
        ...
        c.gridx=2; c.weightx=1; c.fill=GridBagConstraints.BOTH; c.insets=new Insets(0,0,0,0); cols.add(createColumn("/com/pdftoolboxpro/resources/save.png", "image.step2.title", "image.step2.desc"), c);
        ...
        c.gridx=4; c.weightx=1; c.fill=GridBagConstraints.BOTH; c.insets=new Insets(0,0,0,0); cols.add(createColumn("/com/pdftoolboxpro/resources/success.png", "image.step3.title", "image.step3.desc"), c);
        JPanel centerWrapper = new JPanel(new GridBagLayout());
        centerWrapper.setOpaque(false);
        centerWrapper.add(cols);
        btn = new JButton(I18n.get("image.button.toPdf"));
        btn.setPreferredSize(new Dimension(420,40));
        btn.addActionListener(e -> onImageToPdf());
    ...
    public void updateTexts(){
        t1.setText(I18n.get("image.step1.title"));
        d1.setText("<html><center>" + I18n.get("image.step1.desc").replace("\\n", "<br>") + "</center></html>");
        t2.setText(I18n.get("image.step2.title"));
        d2.setText("<html><center>" + I18n.get("image.step2.desc").replace("\\n", "<br>") + "</center></html>");
        t3.setText(I18n.get("image.step3.title"));
        d3.setText("<html><center>" + I18n.get("image.step3.desc").replace("\\n", "<br>") + "</center></html>");
        btn.setText(I18n.get("image.button.toPdf"));
    }

    private void onImageToPdf(){
        ...
        JOptionPane.showMessageDialog(this, I18n.get("dialog.choosesave"), I18n.get("image.step2.title"), JOptionPane.INFORMATION_MESSAGE);
        JFileChooser save=new JFileChooser(); save.setSelectedFile(new File("imagens.pdf"));
        ...
        try{
            new ImageToPdf().convert(Arrays.asList(files), dest);
            String msg = dest.getAbsolutePath() + "\n\n" + I18n.get("dialog.openfolder");
            int opt = JOptionPane.showConfirmDialog(this, msg, I18n.get("image.step3.title"), JOptionPane.YES_NO_OPTION, JOptionPane.INFORMATION_MESSAGE);
