...
public class ZipPanel extends JPanel {
    ...
    public ZipPanel() {
        ...
        c.gridx=0; c.weightx=1; cols.add(createColumn("/com/pdftoolboxpro/resources/pdfs.png", "zip.step1.title", "zip.step1.desc"), c);
        ...
        c.gridx=2; c.weightx=1; c.fill=GridBagConstraints.BOTH; c.insets=new Insets(0,0,0,0); cols.add(createColumn("/com/pdftoolboxpro/resources/save.png", "zip.step2.title", "zip.step2.desc"), c);
        ...
        c.gridx=4; c.weightx=1; c.fill=GridBagConstraints.BOTH; c.insets=new Insets(0,0,0,0); cols.add(createColumn("/com/pdftoolboxpro/resources/success.png", "zip.step3.title", "zip.step3.desc"), c);
        JPanel centerWrapper = new JPanel(new GridBagLayout());
        centerWrapper.setOpaque(false);
        centerWrapper.add(cols);
        btn = new JButton(I18n.get("zip.button"));
        btn.setPreferredSize(new Dimension(420,40));
        btn.addActionListener(e -> onZip());
    ...
    public void updateTexts(){
        t1.setText(I18n.get("zip.step1.title"));
        d1.setText("<html><center>" + I18n.get("zip.step1.desc").replace("\\n", "<br>") + "</center></html>");
        t2.setText(I18n.get("zip.step2.title"));
        d2.setText("<html><center>" + I18n.get("zip.step2.desc").replace("\\n", "<br>") + "</center></html>");
        t3.setText(I18n.get("zip.step3.title"));
        d3.setText("<html><center>" + I18n.get("zip.step3.desc").replace("\\n", "<br>") + "</center></html>");
        btn.setText(I18n.get("zip.button"));
    }
